...
public class EliminarPlantillaGastoRecurrenteService {
    ...
    public void ejecutar(Long plantillaId) {
        ...
        plantilla.validarPlantillaEstaInactiva();
        
        plantillaRepository.eliminar(plantilla.getId());
        
        log.info("Plantilla Gasto Recurrente {} eliminada correctamente", plantilla.getId());
    }
}